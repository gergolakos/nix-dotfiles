...

{
  ...
  system.stateVersion = 4; # required by nix-darwin
  system.defaults = {
    NSGlobalDomain = {
      AppleShowAllExtensions = true; # Shows all file extensions in Finder
      # Lower numbers = faster key repeat
      # 120, 90, 60, 30, 12, 6, 2
      KeyRepeat = 2;
  ...
  # Enable Dock customizations
  services.dock.enable = true;
  services.dock.autohide = true;
  services.dock.show-recents = false;
  services.dock.orientation = "bottom";
